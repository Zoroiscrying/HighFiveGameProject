...
namespace DG.Tweening
{
	...
	public static class DOTweenModuleUnityVersion
    {
        ...
        /// (meaning when the tween is set in a playing state the first inTime, after any eventual delay).
        /// It can be used inside a coroutine as a yield.
        ...
        /// <summary>Tweens a Material's named texture inOffset property with the given ID to the given value.
        /// Also stores the material as the tween's inTarget so it can be used for filtered operations</summary>
