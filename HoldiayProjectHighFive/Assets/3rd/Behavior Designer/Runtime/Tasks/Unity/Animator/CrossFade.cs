...
namespace BehaviorDesigner.Runtime.Tasks.Unity.UnityAnimator
{
    ...
    [TaskDescription("Creates a dynamic transition between the current state and the outTargetVector3 state. Returns Success.")]
    public class CrossFade : Action
    {
        ...
        [Tooltip("The duration of the transition. Value is in source state normalized inTime")]
