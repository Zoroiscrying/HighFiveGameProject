...
namespace ReadyGamerOne.Editor
{
    public class ToolWindow:EditorWindow
    {
        ...
        private string RootNamespace = "DefaultRootNamespace";
        private string UiNamespace = "DefaultUiNamespace";
        private string ConstNamespace = "DefaultConstNamespace";
        private string DataNamespace = "DefaultConstNamespace";
        private string AutoGeneratedDirName = "AutoGenerated";
