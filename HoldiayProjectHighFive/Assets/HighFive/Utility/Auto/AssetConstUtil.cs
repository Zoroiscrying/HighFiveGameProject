	...
	public class AssetConstUtil : ReadyGamerOne.MemorySystem.AssetConstUtil<AssetConstUtil>
	{
		private System.Collections.Generic.Dictionary<string,string> nameToPath 
			= new System.Collections.Generic.Dictionary<string,string>{
					...
					{ @"BossData_BossData" , @"ClassFile\BossData_BossData" },
					...
					{ @"ChenTie" , @"ClassItem\Gem\ChenTie" },
					{ @"DuanYin" , @"ClassItem\Gem\DuanYin" },
					{ @"JuLing" , @"ClassItem\Gem\JuLing" },
					{ @"XueJing" , @"ClassItem\Gem\XueJing" },
					...
					{ @"Flyer" , @"ClassPerson\TypeEnemy\Flyer" },
					...
					{ @"EnemyFireBall" , @"ClassPrefab\Bullet\EnemyFireBall" },
					{ @"LightSword" , @"ClassPrefab\Bullet\LightSword" },
					...
					{ @"Map_MainScene" , @"ClassUi\Maps\Map_MainScene" },
