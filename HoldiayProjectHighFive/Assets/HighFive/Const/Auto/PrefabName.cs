namespace HighFive.Const
{
	public partial class PrefabName
	{
		...
		public static readonly string CurvedBullet = @"CurvedBullet";
		public static readonly string EnemyFireBall = @"EnemyFireBall";
		public static readonly string LightSword = @"LightSword";
		public static readonly string SingleBullet = @"SingleBullet";
