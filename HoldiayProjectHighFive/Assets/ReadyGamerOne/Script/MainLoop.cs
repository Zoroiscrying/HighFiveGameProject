...
namespace ReadyGamerOne.Script
{
    ...
    public class MainLoop : MonoSingleton<MainLoop>
    {
        ...
        public static void AddStartFunc(Action func)
        {
            startEvent += func;
        }

        public static void RemoveStartFunc(Action func)
        {
            startEvent -= func;
        }
        ...
        public static void AddUpdateTest(UpdateTestPair pair)
        {
        ...
        public static void RemoveUpdateTest(UpdateTestPair pair)
        {
        ...
        public static void RemoveUpdateFunc(Action func)
        {
            updateEvent -= func;
        }
        ...
        public static void AddFixedUpdateFunc(Action func)
        {
            fixedUpdateEvent += func;
        }

        public static void RemoveFixedUpdateFunc(Action func)
        {
            fixedUpdateEvent -= func;
        }
        ...
        public static void AddGUIFunc(Action func)
        {
            guiEvent += func;
        }

        public static void RemoveGUIFunc(Action func)
        {
            guiEvent -= func;
        }
