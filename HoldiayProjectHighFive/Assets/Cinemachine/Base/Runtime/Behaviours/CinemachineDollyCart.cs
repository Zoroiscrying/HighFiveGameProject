...
namespace Cinemachine
{
    ...
    public class CinemachineDollyCart : MonoBehaviour
    {
        ...
        /// <summary>Move the cart with this animationSpeed</summary>
        [Tooltip("Move the cart with this animationSpeed along the path.  The value is interpreted according to the Position Units setting.")]
